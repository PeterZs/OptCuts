...
\revised{For higher-genus surfaces, we apply the {\tt cut\_to\_disk} function in libigl\ \cite{libigl} to detect homology generators, connecting all of them to form an initial seam.}
%%
