...
\revised{For higher-genus surfaces, we use \textit{cut\_to\_disk} function in libigl\ \cite{libigl} to detect homology generators, and connect all of them as an initial seam.}
%%
