...
\revised{For higher-genus surfaces we use the {\tt cut\_to\_disk} function in libigl\ \cite{libigl} to detect homology generators and then connect them to form an initial seam.}
%%
